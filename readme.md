...
El archivo log.config.xml contiene la configuración necesaria para trazar las peticiones, esta configuración es **temporal** , y tiene como fin debugear la aplicación en caso de problemas o dudas.

La configuración provista en system.diagnostics escribe a 3 archivos.

Si tu archivo de configuracion no tiene el nodo :

```xml
<system.diagnostics></system.diagnostics>
```
podras pegar la configuración directamente, en caso contrario  deberas adaptar el trazado.

En cualquier caso se debe establecer el **path valido del equipo** en el nodo **initializeData**

```xml
     <add ... initializeData="ESCRIBE AQUI UN PATH  CON PERMISOS DE ESCRITURA" />
...
Ejemplo de como se ve una configuración de una aplicación con trazado activado de peticiones con el path  "C:\\logs\\" 
...
En los archivos se encontrara la información necesaria para detectar el error.
